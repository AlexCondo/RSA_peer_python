...
def Syncronize():
    ...
    while confirm != "Syncronized":
        try:
            s.sendto("Syncronized".encode(), ('localhost',1060))
...
time.sleep(0.5)
s.sendto(n.to_bytes(35,'big'), ('localhost', 1060))

Syncronize()

time.sleep(0.5)
s.sendto(e.to_bytes(35,'big'), ('localhost', 1060))
...
while True:
    ...
    s.sendto(message.to_bytes(35,'big'), ('localhost', 1060))
